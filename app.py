...
async def predict_batch(request: Request):
    ...
    try:
        ...
        firebase_data = {
            ...
            "health":              health,
            "contrib_current":     contrib_c,
            "contrib_temperature": contrib_t,
            "contrib_vibration":   contrib_v,
        ...
        try:
            ...
            logger.info(f"Firebase updated | anomaly={is_anomaly} health={health:.1f}% RUL={rul}")
        except Exception as e:
