...
# Correct import for the 'firebase' package
...
# ------------------------------------------------------------------
# Firebase initialization (using the firebase package)
# ------------------------------------------------------------------
# Replace with your actual database URL (without https://)
FIREBASE_URL = "https://welly001-8ffca-default-rtdb.firebaseio.com/"
# No authentication needed if your database is in test mode
...
async def predict_batch(request: Request):
    try:
        ...
        # ------------------------------------------------------------------
        # Update Firebase (using the firebase package)
        # ------------------------------------------------------------------
        ...
        # Use patch to update specific fields at the '/sensor' path
        try:
