...
def compute_health(error_value, anomaly_threshold):
    # engineered health index based on reconstruction error
...
def estimate_rul(error_value, anomaly_threshold):
    # simple estimated RUL for dashboard use only
...
def batch_predict():
    try:
        ...
        print("reconstruction_error:", reconstruction_error, "elapsed:", round(time.time() - t0, 3), "s")
        ...
        print("feature_errors:", feature_errors.tolist())
